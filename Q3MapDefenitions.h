#ifndef YOEL_QUAKE3_MAP_DEFENITIONS
#define YOEL_QUAKE3_MAP_DEFENITIONS
...
struct tBSPVertex
{
    CVector3f vPosition;			// (x, y, z) position. 
    CVector2f vTextureCoord;		// (u, v) texture coordinate
    CVector2f vLightmapCoord;	// (u, v) lightmap coordinate
    CVector3f vNormal;			// (x, y, z) normal vector
...
struct tBSPFace
{
    ...
    CVector3f lMapPos;			// The 3D origin of lightmap. 
    CVector3f lMapVecs[2];		// The 3D space for s and t unit vectors. 
    CVector3f vNormal;			// The face normal. 
...
class CEntity;
typedef std::vector<CEntity*> ENTITIES_VECTOR;
typedef std::vector<CEntity*>::iterator ENTITIES_VECTOR_I;
...
struct tBSPLeaf
{
	...
	ENTITIES_VECTOR StaticEntities;
	ENTITIES_VECTOR DynamicEntities;	 
...
struct tBSPPlane
{
    CVector3f vNormal;			// Plane normal. 
...
struct tBSPModel 
{
	CVector3f min;			// The min position for the bounding box
	CVector3f max;			// The max position for the bounding box. */
