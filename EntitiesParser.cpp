...
void CEntitiesParser::GetPlayerPosition(int iNum,CVector3f &Vector)
{
	int iTemp=0;
...
int CEntitiesParser::FillPlayerPositions(CVector3f*& pStartPositions)
{	
	...
	pStartPositions = new CVector3f[iPositionsNum];
...
/////
///////////////////////////////// Load \\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\*
void CEntitiesParser::Load(void)
{
